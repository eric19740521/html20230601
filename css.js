                ...
                989: (e, t, s) => {
                    ...
                    e.exports = function (e) {
                        ...
                        if (!s && (!t || Object.keys(e).length > 1)) {
                            ...
                            for (let r = 1; r < 100; r++) {
                                const o = r % 2 == 0;
                                r in e ? (c.length ? (t = r, s = i(e[r]), l(), c.length = 0, a = s) : a = i(e[r]), n = r) : o && c.push(r)
                            }
                            c.length && (t = 100, s = "100" in e ? i(e[100]) : [255, 255, 255], l())
                        }
            ...
            return (() => {
                ...
                class $t {
                    constructor(t, s) {
                        ...
                        if (x || (f = null), s.origin === et)
                            c = s.value, o = v.slice(s.value.length), this.value = h[s.value];
                        else {
                            if (s.origin === Ke)
                                if (d === Ce) {
                                    let e = 0;
                                    ...
                                    this.prefix.includes("(") ? (this.prefix = void 0, c = v) : c = v.slice(e + 1)
                                }
                            else
                                s.origin === tt && (this.symbol = v[0], c = v.slice(1));
                            let e,
                            t = "",
                            i = [],
                            n = 0;
                            !function s(l, o, d = "") {
                                let h,
                                m = !1;
                                for (l && (")" === l && "$" === t.slice(-1) ? h = t.length - 1 : "'" === l && (m = !0), t += c[n++]); n < c.length; n++) {
                                    const x = c[n];
                                    if (x === l) {
                                        if (t += x, m) {
                                            let e = 0;
                                        ...
                                        o || (m ? i.push(t) : (e = r(t, u, f, p, k), i.push(e.value + e.unit)), d = "", t = "");
                                        break
                                    }
                                    if (!m && x in a)
                                        ...
                                        l ? t += " " : (e = r(t, u, f, p, k), i.push(e.value + e.unit), t = "")
                                }
                            }
                            (),
                            t && (e = r(t, u, f, p, k), i.push(e.value + e.unit)),
                            o = c.slice(n),
                            1 === i.length ? e ? (this.value = e.value, this.unit = e.unit) : (this.value = i[0], this.unit = "") : this.value = i.reduce(((e, t, s) => e + t + ("," === t || "," === i[s + 1] || s === i.length - 1 ? "" : " ")), "")
                        }
                                    ...
                                    if (!e) {
                                        ...
                                        for (const e of n)
                                            if ("all" === e || "print" === e || "screen" === e || "speech" === e)
                                                ...
                                                n = "",
                                                a = 0;
                                                switch (e.startsWith("<=") ? (n = "<=", s = st) : e.startsWith(">=") || b[e] ? (n = ">=", s = it) : e.startsWith(">") ? (n = ">", s = it, a = .02) : e.startsWith("<") && (n = "<", s = st, a =  - .02), s) {
                                                case st:
                                                case it:
                    ...
                    static extend(e, ...t) {
                        ...
                        i = (e, t, i) => {
                            ...
                            for (const n in s) {
                                const a = s[n];
                                null == a ? n in e && (null == i || i(n), delete e[n]) : e[n] = null !== (r = null == t ? void 0 : t(n, a)) && void 0 !== r ? r : a
                            }
                        };
                        switch (e) {
                        case "classes":
                            ...
                            break;
                        case "colors":
                            i(this.colors, ((e, t) => (-1 === this.colorNames.indexOf(e) && this.colorNames.push(e), Je(t))), (e => {
                ...
                class Ct extends At {
                        ...
                        if (super((e => {
                                    ...
                                    l = (e, t) => {
                                        for (let s = 0; s < e.length; s++) {
                                            const a = e[s];
                                            !a.classList || i.includes(a) || r.includes(a) || (a.isConnected !== t ? (i.push(a), n(a, t)) : r.push(a))
                                        }
                                    };
                                    for (let t = 0; t < e.length; t++) {
                                        ...
                                        if ("attributes" === c) {
                                            ...
                                            l(n, !1), o.isConnected && i.includes(o) || l(a, !0)
                                    }
                                    if (s.length || Object.keys(t).length) {
                                        for (const {
                                            ...
                                            for (const e in t) {
                                                ...
                                                0 === i ? (delete this.countOfName[e], this.delete(e)) : (e in this.countOfName || this.findAndInsert(e), this.countOfName[e] = i)
                                            }
                                        }
                                    })), this.container = e, this.styles = [], this.styleOfName = {}, this.countOfName = {}, Rt) {
                                if (e) {
                                    ...
                                    if (t) {
                                                ...
                                                for (let i = 0; i < e.length; i++) {
                                                    ...
                                                    if ("." === r[0]) {
                                                        ...
                                                        if (!(i in this.styleOfName) && !(i in $t.classes)) {
                                                            ...
                                                            e && (e.cssRule = null != s ? s : t, this.styles.push(e), this.styleOfName[e.name] = e)
                                                        }
                                                    }
                                                }
                                            } else if (t.cssRules)
                                        ...
                                        this.element = zt.cloneNode(), null == e || e.prepend(this.element)
                                }
                                Nt.push(this)
                            }
                    }
                    observe(e, t = {
                        ...
                        const s = e => {
                            e.forEach((e => {
                                    e in this.countOfName ? this.countOfName[e]++ : (this.countOfName[e] = 1, this.findAndInsert(e))
                                }))
                        };
                    ...
                    insert(e) {
                        ...
                        if (r) {
                            ...
                            if (c)
                                s = this.styles.findIndex((e => !e.hasWhere || e.media || -1 !== e.prioritySelectorIndex || e.order >= n)), -1 === s && (s = i + 1);
                            else {
                                let e = 0;
                        ...
                        s = e => {
                            ...
                            if (!(!(null == s ? void 0 : s.cssRule) || e in $t.relations && $t.relations[e].some((e => e in this.countOfName))))
                                for (let e = 0; e < t.cssRules.length; e++) {
                                    t.cssRules[e] === s.cssRule && (t.deleteRule(e), this.styles.splice(e, 1), delete this.styleOfName[s.name])
                                }
                        };
                        if (e in $t.classes)
                ...
                function mi(e, t) {
                    ...
                    return function r(n, a) {
                        ...
                        const l = a ? t(a) : "",
                        o = () => {
                            c && (s += !l || Number.isNaN(+c) ? c : +c / (l === we ? 16 : 1) + l, c = "")
                        };
                        for (; i < e.length; i++) {
                            const t = e[i];
                            if (t === n && ("'" !== n || ")" === e[i + 1])) {
                            ...
                            "," === t || " " === t ? (o(), s += t) : c || "'" !== t ? c && "(" === t ? (s += c + t, i++, r(")", c), c = "") : c += t : (s += t, i++, r(t), c = "")
                        }
                        o()
                    }
                    (),
